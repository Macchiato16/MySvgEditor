    ...
    ui(new Ui::KosoSvg)
{
    ...
    if (toolBar) {
        ...
        QAction *starAction = toolBar->addAction(QIcon(":/image/star.png"), tr("五角星"));
        starAction->setObjectName("star_action");
        connect(starAction, &QAction::triggered, this, &MySvg::on_star_action_triggered);
    }
    msv = new CanCvns();
...
void MySvg::on_star_action_triggered()
{
    msv->change(MyShapeType::star);
}
